...
@section('title', 'Service Cost Analytics')
@section('navbar')
        ...
        <div class="report-container bg-white rounded-4 shadow-sm p-3 p-md-4 mb-4">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3 mb-md-4 gap-2">
                ...
                <div class="d-flex gap-2 w-100 w-md-auto">
                    <a href="{{ route('cost.report.download', request()->all()) }}" class="btn btn-sm btn-outline-dark rounded-pill px-3 flex-grow-1 flex-md-grow-0">
