            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('superadmin-admins.update', $superadmin_admin->id) }}" method="POST" id="adminForm" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                                    ...
                                    <select name="company_id" id="company_id"
                                        ...
                                        @foreach($companies as $company)
                                            <option value="{{ $company->id }}"
                                                {{ old('company_id', $superadmin_admin->company_id) == $company->id ? 'selected' : '' }}>
