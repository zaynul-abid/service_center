    ...
    <div class="card-body">
        ...
        <form action="{{ route('companies.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="plan" class="form-control @error('plan') is-invalid @enderror" value="{{ old('plan') }}">
            ...
            <div class="mb-3">
                ...
                <input type="date" name="subscription_start_date" class="form-control @error('subscription_start_date') is-invalid @enderror" value="{{ old('subscription_start_date') }}">
            ...
            <div class="mb-3">
                ...
                <input type="date" name="subscription_end_date" class="form-control @error('subscription_end_date') is-invalid @enderror" value="{{ old('subscription_end_date') }}">
